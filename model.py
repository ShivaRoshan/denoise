...
class Denoiser(object):
    ...
    def build_model(self):
        ...
        tf.compat.v1.add_to_collection('InNOut', self.input)
        tf.compat.v1.add_to_collection('InNOut', self.output)
    ...
    def noise_encoder(self):
        with tf.compat.v1.variable_scope('Noise_ENC'):
...
class Estimator(object):
    ...
    def build_model(self):
        ...
        with tf.compat.v1.variable_scope(self.name, reuse=self.reuse):
            ...
            self.output=tf.compat.v1.image.resize_bilinear(self.net, tf.shape(self.input)[1:-1])
